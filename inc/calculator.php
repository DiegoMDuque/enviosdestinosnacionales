            ...
            <div class="nk-wrap ">
                ...
                <div class="nk-content ">
                    <?php $core = new Core ?>
                    <script>
                    const costoXKilo = "<?php echo $core->costoXKilo?>"
                    const costoXmetros = "<?php echo $core->costoXmetros?>"
                    const RTFuente = "<?php echo $core->RTFuente?>"
                    ...
                    <div class="container-fluid">
                        <div class="nk-content-inner">
                            <div class="nk-content-body">
                                <div class="col-12 col-md-12 card-bordered shadow-sm mx-1">
                                    <div class="border-bottom p-3 mb-1">
                                        <h6 class="title"><em class="icon fas fa-calculator mx-2"></em>Calculadora
                                        </h6>
                                    </div>
                                    <form id="calculadora">
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="text" class="form-control" name=="weight"
                                                            id="weight" value="0" placeholder="Peso Kg.">
                                                    </div>
                                                </div>
                                                <!--Peso -->
                                                <div class="form-group col-6">
                                                    <label class="form-label" for="default-03">Valor
                                                        declarado</label>
                                                    <div class="form-control-wrap">
                                                        <div class="form-icon form-icon-left">
                                                            <em class="icon fas fa-dollar-sign"></em>
                                                        </div>
                                                        <input type="text" class="form-control formato-peso"
                                                            name="valor_declarado" id="valor_declarado"
                                                ...
                                                <div class="form-group col-4">
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="text" class="form-control" name="length"
                                                            id="length" placeholder="Largo" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--Volumen-->
                                                ...
                                                <div class="col-6">
                                                    <div class="preview-block">
                                                        <div class="my-2 overline-title d-flex">
                                                            <em
                                                                class="text-success fa-solid fa-truck  mx-1"></em>Recodida
                                                            <div
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="form-control-wrap">
                                                                        <select name="select_pick_up_service[]"
                                                                            ...
                                                                            <option cost="<?php echo $pickUp->cost ?>"
                                                                                value="<?php echo $pickUp->id ?>">
                                                        ...
                                                        <tfoot class="input-totali">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" name="total_costo_envio"
                                                                        id="total_costo_envio" value="$00.0" readonly>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2"></td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" name="total_rtfuente"
                                                                        id="total_rtfuente" value="$00.0" readonly>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2"></td>
                                                                ...
                                                                <td><input type="text" name="total_subtotal"
                                                                        id="total_subtotal" value="$00.0" readonly>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2"></td>
                                                                ...
                                                                <td><input type="text" name="total_total"
                                                                        id="total_total" value="$00.0" readonly>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
