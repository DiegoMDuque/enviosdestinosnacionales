...
function btnDeleteDispatched(guia){
  $('#guia-' + guia).remove()
...
function Select2Error(element){
  element = element.remplace('#','')
  $('document').find('select2-selection').each(function(){
    var arr = 'select2-'+element+'-container';
    if(arr == $(this).attr('aria-labelledby')){
